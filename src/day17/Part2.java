...
public class Part2 {
    ...
    List<Integer> program = new java.util.ArrayList<>(List.of(2, 4, 1, 5, 7, 5, 1, 6, 0, 3, 4, 1, 5, 5, 3, 0));
    ...
    void dfs(int i) {
        ...
        // Every dfs, find A such that ((A%8) xor 3 xor (A>>(A%8 xor 5))%8) = i/3th digit of program, set A = A>>3, repeat
    ...
    void runProgram(long a) {
        ...
        var program = Arrays.stream("2,4,1,5,7,5,1,6,0,3,4,1,5,5,3,0".split(",")).mapToInt(Integer::parseInt).toArray();
